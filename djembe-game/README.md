...
- **튜토리얼** — 단계별 학습
- **도전과제** — 22개 achievement (기본 10 + 리듬 도감 12)
- **오프라인 캘리브레이션** — 디바이스 입력 지연 보정

## 🥁 리듬 도감 (NEW)

서아프리카 전통 젬베 리듬 학습 시스템:

- **12개 전통 리듬** — Kuku, Soli, Djansa, Sunu, Macru, Yankadi, Tiriba, Dundunba, Sofa, Kassa, Lamba, Kakilambe
- **10단계 별점 난이도** — ★1 (입문) ~ ★10 (마스터급)
- **카테고리 필터** — 지역 / 용도 / 템포 / 난이도 / 검색
- **루프 연습 모드** — BPM 슬라이더 + Auto BPM Up
- **5단계 학습 모드** — 보기 → 듣기 → 따라치기 → 함께치기 → 마스터
- **메들리 챌린지** — 5개 사전 정의 + 직접 만들기
- **백과사전** — 젬베 역사, 구조, 5명의 마스터, 20개 용어 사전
- **통계 대시보드** — 진행도, 지역별 클리어, 최고 BPM, 다음 추천
